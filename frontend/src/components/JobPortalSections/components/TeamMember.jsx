    ...
    <section className="bg-gradient-to-b from-white via-gray-50 to-white py-20">
      <div className="max-w-5xl mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
          Passionate people behind the Project. Brings experience and heart to
          every project.
        </p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-32 h-32 rounded-full object-cover shadow-md group-hover:scale-116   transition-transform duration-300"
                />
